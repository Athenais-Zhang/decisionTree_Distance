...
from DT_before0627.DTforSeq_03_memory import global_var, tools
import numpy as np

from DT_before0627.DTforSeq_03_memory.DT_Seq import DT_seq
...
if __name__ == '__main__':
    global_var._init()
    test("../../dataset/sequence/activity.txt")
