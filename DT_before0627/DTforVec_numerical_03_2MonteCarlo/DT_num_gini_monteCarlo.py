...
from DT_before0627.DTforVec_numerical_03_2MonteCarlo import tools
    ...
    def fit(self, indeices=[], cate=None, represent=None):
        ...
        for cate in cates:
            if giniIndeies[cate] == 0:
                self.childTree[cate] = DT_num_gini_monteCarlo(self.curDepth, self.maxLeafSize, self.meanWay, self.maxDepth)
