...
from DT_before0627.DTforVec_categorical_02_3contrast import constant, tools


class DT_vec_gini_exhaustion:
    height = 0  # 树高
    maxDepth = 0  # 最大深度
    curDepth = 0  # 当前深度
    curNode = 0  # 当前节点
    ...
    def fit(self, indeices=[], cate=None, represent=None):
        ...
        for cate in cates:
            if giniIndeies[cate] == 0:
                self.childTree[cate] = DT_vec_gini_exhaustion(self.curDepth, self.maxLeafSize, self.meanWay, self.maxDepth)
