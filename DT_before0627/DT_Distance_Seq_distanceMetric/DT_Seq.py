...
from DT_before0627.DT_Distance_Seq_distanceMetric import constant
from DT_before0627.DT_Distance_Seq_distanceMetric.tools import findCenter, calDis
    ...
    def fit(self, indeices, cate=None, represent=None):
        ...
        for c in cates:
            if len(childIndeices[c]) == 0:
                ...
                self.children[c].center = constant.get_value('gl_Xtrain')[represents[c]]
            else:
                self.children[c] = DT_seq()
